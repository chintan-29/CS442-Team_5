...
public class speckey extends Activity {
	...
	Button up, down, left, right, f1, f2, f3, f4, f5f6, f7, f8, f9, f10, f11,
			f12, esc, insert, prntscr, delete, tab, home, pgup, pgdn, end, win;
		...
		win.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					Tou_Button.dataOutputStream.writeInt(48);
